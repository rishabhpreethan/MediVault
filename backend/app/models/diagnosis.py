...
class Diagnosis(Base):
    ...
    member: Mapped["FamilyMember"] = relationship("FamilyMember", back_populates="diagnoses")  # noqa: F821
    document: Mapped[Optional["Document"]] = relationship("Document", back_populates="diagnoses")  # noqa: F821
